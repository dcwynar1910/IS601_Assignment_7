...
# Environment Variables to reach for variables in env
QR_DIRECTORY = os.getenv('QR_CODE_DIR', 'qr_codes')  # Directory
FILL_COLOR = os.getenv('FILL_COLOR', 'gold')  # Fill color
BACK_COLOR = os.getenv('BACK_COLOR', 'purple')  # Background color

# Method to create logging
def setup_logging():
    logging.basicConfig(
        level=logging.INFO,
...
# Creates the directory with the env variable
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/dcwynar1910')
    args = parser.parse_args() # parses out the given logs
